...
DecagonCTD ctd_1(*CTDSDI12address_1, CTDPower, CTDData, CTDNumberReadings);
DecagonCTD ctd_10(*CTDSDI12address_10, CTDPower, CTDData, CTDNumberReadings);
...
Variable* variableList[] = {
    ...
    new DecagonCTD_Cond(&ctd_1,"12345678-abcd-1234-ef00-1234567890ab"),
    new DecagonCTD_Temp(&ctd_1, "12345678-abcd-1234-ef00-1234567890ab"),
    new DecagonCTD_Depth(&ctd_1, "12345678-abcd-1234-ef00-1234567890ab"),
    new DecagonCTD_Cond(&ctd_10, "12345678-abcd-1234-ef00-1234567890ab"),
    new DecagonCTD_Temp(&ctd_10, "12345678-abcd-1234-ef00-1234567890ab"),
    new DecagonCTD_Depth(&ctd_10, "12345678-abcd-1234-ef00-1234567890ab"),
